...
| JSP-000010 | [abc conjecture](catalog-0001-0100.md#JSP-000010) | Progress | No | No | Unavailable |
...
| JSP-000041 | [Consecutive prime gap bound of 186](catalog-0001-0100.md#JSP-000041) | Progress | Conditional proof | No | Unavailable |
| JSP-000042 | [Crouzeix conjecture](catalog-0001-0100.md#JSP-000042) | Progress | Pending confirmation | No | Unavailable |
...
| JSP-000044 | [Must a set of positive integers whose reciprocals have divergent sum contain arithmetic progressions of every finite length?](catalog-0001-0100.md#JSP-000044) | Progress | No | No | Unavailable |
...
| JSP-000048 | [Do the positive odd integers not expressible as a prime plus two nonnegative powers of 2 have positive upper density?](catalog-0001-0100.md#JSP-000048) | Progress | No | No | Unavailable |
| JSP-000049 | [Is there a fixed bound on the number of powers of 2 needed, together with one prime, to represent every sufficiently large integer?](catalog-0001-0100.md#JSP-000049) | Progress | No | No | Unavailable |
| JSP-000050 | [Is every sufficiently large odd integer the sum of a squarefree positive integer and a power of 2?](catalog-0001-0100.md#JSP-000050) | Progress | No | No | Unavailable |
| JSP-000051 | [How dense can an infinite integer set be if no element divides the sum of two larger elements? Must its reciprocal sum converge?](catalog-0001-0100.md#JSP-000051) | Progress | No | No | Unavailable |
...
| JSP-000053 | [Does the alternating series formed by weighting reciprocal primes by their indices converge?](catalog-0001-0100.md#JSP-000053) | Progress | No | No | Unavailable |
| JSP-000054 | [cluster primes](catalog-0001-0100.md#JSP-000054) | Progress | No | No | Unavailable |
| JSP-000055 | [practical numbers](catalog-0001-0100.md#JSP-000055) | Progress | No | No | Unavailable |
| JSP-000056 | [Is the union of n edge-disjoint complete graphs, each on n vertices, always properly colorable with n colors?](catalog-0001-0100.md#JSP-000056) | Progress | No | No | Unavailable |
| JSP-000057 | [sunflower conjecture](catalog-0001-0100.md#JSP-000057) | Progress | No | No | Unavailable |
...
| JSP-000062 | [How large can a set with distinct two-element sums in a finite integer interval be, and how large is the error from the leading term?](catalog-0001-0100.md#JSP-000062) | Progress | No | No | Unavailable |
| JSP-000063 | [How sparse can an additive complement of the primes be if every sufficiently large integer must be a prime plus an element of that complement?](catalog-0001-0100.md#JSP-000063) | Progress | No | No | Unavailable |
| JSP-000064 | [What is the smallest possible size of an additive complement of the squares that represents every sufficiently large integer?](catalog-0001-0100.md#JSP-000064) | Progress | No | No | Unavailable |
| JSP-000065 | [minimum overlap problem](catalog-0001-0100.md#JSP-000065) | Progress | No | No | Unavailable |
...
| JSP-000067 | [Can an infinite positive-integer set have distinct two-element sums and nearly square-root growth in arbitrarily large intervals?](catalog-0001-0100.md#JSP-000067) | Progress | No | No | Unavailable |
...
| JSP-000069 | [How dense can an integer set be if distinct triples have distinct sums?](catalog-0001-0100.md#JSP-000069) | Progress | No | No | Unavailable |
...
| JSP-000074 | [For each value attained by Euler's totient, study the ratio of its smallest preimage to that value.](catalog-0001-0100.md#JSP-000074) | Progress | No | No | Unavailable |
| JSP-000075 | [sum-product problem](catalog-0001-0100.md#JSP-000075) | Progress | No | No | Unavailable |
...
| JSP-000079 | [How many quadrilaterals are forced when a graph's edge count exceeds the threshold for containing one?](catalog-0001-0100.md#JSP-000079) | Progress | No | No | Unavailable |
| JSP-000080 | [Must a graph excluding a prescribed induced subgraph contain a sufficiently large clique or independent set?](catalog-0001-0100.md#JSP-000080) | Progress | No | No | Unavailable |
| JSP-000081 | [Must two graphs of uncountable chromatic number have a common subgraph of large chromatic number?](catalog-0001-0100.md#JSP-000081) | Progress | No | No | Unavailable |
...
| JSP-000083 | [What lower bounds hold for the sum of reciprocals of a graph's distinct cycle lengths, and how does this sum reflect its structure?](catalog-0001-0100.md#JSP-000083) | Progress | No | No | Unavailable |
| JSP-000084 | [Can an integer set have a number of two-element sum representations growing asymptotically like a logarithm?](catalog-0001-0100.md#JSP-000084) | Progress | No | No | Unavailable |
...
| JSP-000088 | [Does every two-coloring of triples from a set of continuum cardinality contain a monochromatic subset of the prescribed order type?](catalog-0001-0100.md#JSP-000088) | Progress | No | No | Unavailable |
...
| JSP-000097 | [How many triangles sharing one edge must a sufficiently dense graph contain?](catalog-0001-0100.md#JSP-000097) | Progress | No | No | Unavailable |
| JSP-000098 | [What is the minimum number of cliques whose edge sets partition all edges of a chordal graph?](catalog-0001-0100.md#JSP-000098) | Progress | No | No | Unavailable |
| JSP-000099 | [How large a regular induced subgraph is guaranteed in an arbitrary graph of given size?](catalog-0001-0100.md#JSP-000099) | Progress | No | No | Unavailable |
| JSP-000100 | [How many different sets of cycle lengths occur among graphs with a given number of vertices?](catalog-0001-0100.md#JSP-000100) | Progress | No | No | Unavailable |
...
| JSP-000105 | [Distinct distances determined by planar point sets](catalog-0101-0200.md#JSP-000105) | Progress | No | No | Unavailable |
| JSP-000106 | [unit distance problem](catalog-0101-0200.md#JSP-000106) | Solved | Yes | Yes | Unclaimed |
| JSP-000107 | [Are there essentially different geometric configurations minimizing the number of distinct distances among planar points?](catalog-0101-0200.md#JSP-000107) | Progress | No | No | Unavailable |
...
| JSP-000109 | [What is the maximum number of unit-distance pairs among the vertices of a convex polygon?](catalog-0101-0200.md#JSP-000109) | Progress | No | No | Unavailable |
...
| JSP-000111 | [How many distinct distances must a planar point set in general position determine?](catalog-0101-0200.md#JSP-000111) | Progress | No | No | Unavailable |
| JSP-000112 | [Must a minimum-diameter point set satisfying the prescribed distance constraints contain an equilateral triangle of side length one?](catalog-0101-0200.md#JSP-000112) | Progress | No | No | Unavailable |
| JSP-000113 | [How large must a planar point set's diameter be if its distinct distances have the prescribed separation?](catalog-0101-0200.md#JSP-000113) | Progress | No | No | Unavailable |
...
| JSP-000117 | [How many unit circles can pass through at least three points of a finite planar point set?](catalog-0101-0200.md#JSP-000117) | Progress | No | No | Unavailable |
...
| JSP-000120 | [Must a graph of sufficiently large chromatic number contain a subgraph with both large girth and large chromatic number?](catalog-0101-0200.md#JSP-000120) | Progress | No | No | Unavailable |
...
| JSP-000122 | [Can every finite subgraph of a graph with uncountable chromatic number be made bipartite by deleting very few edges?](catalog-0101-0200.md#JSP-000122) | Progress | No | No | Unavailable |
| JSP-000123 | [How large must a directed graph be to force an independent set or a transitive tournament of a prescribed size?](catalog-0101-0200.md#JSP-000123) | Progress | No | No | Unavailable |
...
| JSP-000125 | [If the size of a pairwise noncommuting subset of a group is bounded, how many abelian subgroups are needed to cover the group?](catalog-0101-0200.md#JSP-000125) | Progress | No | No | Unavailable |
...
| JSP-000128 | [Avoiding affine copies of infinite real sets](catalog-0101-0200.md#JSP-000128) | Progress | No | No | Unavailable |
...
| JSP-000131 | [Can sets of integers using only a few allowed digits in different bases together represent every sufficiently large integer?](catalog-0101-0200.md#JSP-000131) | Progress | No | No | Unavailable |
...
| JSP-000135 | [ambiguous statement](catalog-0101-0200.md#JSP-000135) | Progress | No | No | Unavailable |
...
| JSP-000143 | [Are there arbitrarily long arithmetic progressions whose terms are consecutive primes in the full prime sequence?](catalog-0101-0200.md#JSP-000143) | Progress | No | No | Unavailable |
| JSP-000144 | [How large can a subset of a finite integer interval be if it contains no arithmetic progression of a specified length?](catalog-0101-0200.md#JSP-000144) | Progress | No | No | Unavailable |
| JSP-000145 | [How dense can a set of real numbers be if distinct elements avoid prescribed neighborhoods of one another's integer multiples?](catalog-0101-0200.md#JSP-000145) | Progress | No | No | Unavailable |
| JSP-000146 | [Determine the average and growth of fixed powers of gaps between consecutive squarefree numbers.](catalog-0101-0200.md#JSP-000146) | Progress | No | No | Unavailable |
...
| JSP-000149 | [How does the minimum number of colors needed to give nearby edges different colors depend on the maximum degree?](catalog-0101-0200.md#JSP-000149) | Progress | No | No | Unavailable |
| JSP-000150 | [What is the smallest vertex set meeting every maximal clique of a graph?](catalog-0101-0200.md#JSP-000150) | Progress | No | No | Unavailable |
...
| JSP-000156 | [How dense can an integer set be if each integer has at most two representations as a sum of two of its elements?](catalog-0101-0200.md#JSP-000156) | Progress | No | No | Unavailable |
...
| JSP-000158 | [How many colors are needed to color consecutive integers so that every four-term arithmetic progression uses at least three colors?](catalog-0101-0200.md#JSP-000158) | Progress | No | No | Unavailable |
| JSP-000159 | [How does density affect the threshold for finding the specified color-balanced structure in a two-colored hypergraph?](catalog-0101-0200.md#JSP-000159) | Progress | No | No | Unavailable |
...
| JSP-000162 | [What is the precise asymptotic growth of the Ramsey number for a triangle versus a large clique?](catalog-0101-0200.md#JSP-000162) | Progress | No | No | Unavailable |
...
| JSP-000165 | [What is the maximum density of an integer set containing no number together with both its double and its triple?](catalog-0101-0200.md#JSP-000165) | Progress | No | No | Unavailable |
| JSP-000166 | [How large can the sum of reciprocals of an integer set be if it contains no arithmetic progression of a specified length?](catalog-0101-0200.md#JSP-000166) | Progress | No | No | Unavailable |
| JSP-000167 | [sparse ruler problem](catalog-0101-0200.md#JSP-000167) | Progress | No | No | Unavailable |
| JSP-000168 | [Does every finite coloring of the positive integers contain a large set whose specified sums and products all have the same color?](catalog-0101-0200.md#JSP-000168) | Progress | No | No | Unavailable |
| JSP-000169 | [Does every two-coloring of the plane contain a monochromatic congruent copy of a prescribed triangle?](catalog-0101-0200.md#JSP-000169) | Progress | No | No | Unavailable |
| JSP-000170 | [Which finite point configurations have a monochromatic congruent copy under every finite coloring in sufficiently high dimension?](catalog-0101-0200.md#JSP-000170) | Progress | No | No | Unavailable |
| JSP-000171 | [How small can one make the discrepancy of signed sums along arithmetic progressions?](catalog-0101-0200.md#JSP-000171) | Progress | No | No | Unavailable |
| JSP-000172 | [Can signs be assigned to the positive integers so that discrepancy along each arithmetic progression satisfies an optimal bound depending only on its common difference?](catalog-0101-0200.md#JSP-000172) | Progress | No | No | Unavailable |
...
| JSP-000175 | [Is the Ramsey number of a high-dimensional hypercube bounded by a constant times its number of vertices?](catalog-0101-0200.md#JSP-000175) | Progress | No | No | Unavailable |
...
| JSP-000178 | [Can the edges of every finite graph be partitioned into linearly many cycles and single edges, in terms of its number of vertices?](catalog-0101-0200.md#JSP-000178) | Progress | No | No | Unavailable |
...
| JSP-000188 | [How large a subset avoiding arithmetic progressions of a prescribed length must every finite integer set contain?](catalog-0101-0200.md#JSP-000188) | Progress | No | No | Unavailable |
...
| JSP-000209 | [How many representations can a single integer have as a prime plus a power of two?](catalog-0201-0300.md#JSP-000209) | Progress | No | No | Unavailable |
| JSP-000210 | [How long a run of unusually large consecutive prime gaps can occur?](catalog-0201-0300.md#JSP-000210) | Progress | No | No | Unavailable |
...
| JSP-000214 | [What structure must a nearly quadratically growing integer sequence have if its reciprocal sum is rational?](catalog-0201-0300.md#JSP-000214) | Progress | No | No | Unavailable |
| JSP-000215 | [What is the density of integers representable as a prime plus the floor of the specified exponential expression?](catalog-0201-0300.md#JSP-000215) | Progress | No | No | Unavailable |
...
| JSP-000217 | [Is the infinite series defined by sparse nonzero binary digits transcendental?](catalog-0201-0300.md#JSP-000217) | Progress | No | No | Unavailable |
...
| JSP-000219 | [Is the binary generating series constructed from primes irrational?](catalog-0201-0300.md#JSP-000219) | Progress | No | No | Unavailable |
| JSP-000220 | [Are the series with divisor-power sums as numerators and factorials as denominators irrational?](catalog-0201-0300.md#JSP-000220) | Progress | No | No | Unavailable |
| JSP-000221 | [What conditions ensure that finite sums of distinct elements of an integer set represent every sufficiently large integer?](catalog-0201-0300.md#JSP-000221) | Progress | No | No | Unavailable |
| JSP-000222 | [How large must the maximum modulus of the specified product of binomials on the unit circle be?](catalog-0201-0300.md#JSP-000222) | Progress | No | No | Unavailable |
| JSP-000223 | [Under the stated conditions, is every infinite subsum of reciprocals of powers of two minus one irrational?](catalog-0201-0300.md#JSP-000223) | Progress | No | No | Unavailable |
...
| JSP-000225 | [Must the binary-weighted infinite sum associated with the specified sparse integer sequence be irrational?](catalog-0201-0300.md#JSP-000225) | Progress | No | No | Unavailable |
...
| JSP-000227 | [Is there an integer sequence whose reciprocal sum remains irrational after every term undergoes the prescribed asymptotically small perturbation?](catalog-0201-0300.md#JSP-000227) | Progress | No | No | Unavailable |
| JSP-000228 | [Is there an integer sequence whose reciprocal sum remains irrational under arbitrary bounded perturbations of its terms?](catalog-0201-0300.md#JSP-000228) | Progress | No | No | Unavailable |
| JSP-000229 | [ambiguous statement](catalog-0201-0300.md#JSP-000229) | Progress | No | No | Unavailable |
| JSP-000230 | [When must the reciprocal sum of a sparse subsequence of Fibonacci numbers be irrational?](catalog-0201-0300.md#JSP-000230) | Progress | No | No | Unavailable |
...
| JSP-000232 | [Stanley sequences](catalog-0201-0300.md#JSP-000232) | Progress | No | No | Unavailable |
| JSP-000233 | [How large can a family of sets be if every pairwise intersection is a nonempty arithmetic progression?](catalog-0201-0300.md#JSP-000233) | Progress | No | No | Unavailable |
...
| JSP-000235 | [Herzog-Schönheim conjecture](catalog-0201-0300.md#JSP-000235) | Progress | No | No | Unavailable |
| JSP-000236 | [Is there a Lucas sequence consisting entirely of composite terms but with no fixed nontrivial divisor common to all terms?](catalog-0201-0300.md#JSP-000236) | Progress | No | No | Unavailable |
...
| JSP-000240 | [Does the greedy Egyptian-fraction algorithm restricted to odd denominators always terminate for rational inputs?](catalog-0201-0300.md#JSP-000240) | Progress | No | No | Unavailable |
...
| JSP-000247 | [When can a finite harmonic sum, expressed over the least common multiple of its initial integers, be reduced further?](catalog-0201-0300.md#JSP-000247) | Progress | No | No | Unavailable |
...
| JSP-000249 | [ambiguous statement](catalog-0201-0300.md#JSP-000249) | Progress | No | No | Unavailable |
...
| JSP-000251 | [How many unit fractions are needed to represent one if every denominator must exceed a prescribed threshold?](catalog-0201-0300.md#JSP-000251) | Progress | No | No | Unavailable |
...
| JSP-000254 | [How large can a subset of an integer interval be if no element's reciprocal equals the sum of two other elements' reciprocals?](catalog-0201-0300.md#JSP-000254) | Progress | No | No | Unavailable |
| JSP-000255 | [What is the minimum number of distinct positive unit fractions needed to represent a given positive rational number?](catalog-0201-0300.md#JSP-000255) | Progress | No | No | Unavailable |
...
| JSP-000257 | [Which positive rational numbers are sums of unit fractions whose denominators are products of two distinct primes?](catalog-0201-0300.md#JSP-000257) | Progress | No | No | Unavailable |
...
| JSP-000260 | [How closely can a subsum of positive unit fractions with denominators in a finite range approximate one?](catalog-0201-0300.md#JSP-000260) | Progress | No | No | Unavailable |
...
| JSP-000265 | [How large can a minimal nonempty zero-sum collection of signed integer reciprocals be?](catalog-0201-0300.md#JSP-000265) | Progress | No | No | Unavailable |
...
| JSP-000268 | [How many representations can an integer have as a prescribed number of integer powers of the same degree?](catalog-0201-0300.md#JSP-000268) | Progress | No | No | Unavailable |
| JSP-000269 | [How many integers in a finite interval are sums of a prescribed number of like powers?](catalog-0201-0300.md#JSP-000269) | Progress | No | No | Unavailable |
| JSP-000270 | [Can the integer values of a polynomial form a Sidon sequence?](catalog-0201-0300.md#JSP-000270) | Progress | No | No | Unavailable |
| JSP-000271 | [How many integers in a finite interval are sums of three like powers?](catalog-0201-0300.md#JSP-000271) | Progress | No | No | Unavailable |
...
| JSP-000274 | [For an infinite Sidon set, how large can the limsup of its counting function divided by the square root of the interval length be?](catalog-0201-0300.md#JSP-000274) | Progress | No | No | Unavailable |
...
| JSP-000276 | [What conditions ensure uniformly bounded gaps between differences occurring repeatedly in an integer set?](catalog-0201-0300.md#JSP-000276) | Progress | No | No | Unavailable |
| JSP-000277 | [How small a prime-factor bound suffices to express an integer as a sum of two integers having only small prime factors?](catalog-0201-0300.md#JSP-000277) | Progress | No | No | Unavailable |
...
| JSP-000293 | [Must every measurable planar set of sufficiently large area contain a triangle of area exactly one?](catalog-0201-0300.md#JSP-000293) | Progress | No | No | Unavailable |
| JSP-000294 | [Can distinct-element sums from the union of two floored exponential sequences represent every sufficiently large integer?](catalog-0201-0300.md#JSP-000294) | Progress | No | No | Unavailable |
| JSP-000295 | [How long can an increasing integer sequence in a prescribed range be if all sums of consecutive terms are distinct?](catalog-0201-0300.md#JSP-000295) | Progress | No | No | Unavailable |
...
| JSP-000297 | [segmented numbers](catalog-0201-0300.md#JSP-000297) | Progress | No | No | Unavailable |
...
| JSP-000311 | [Are infinitely many central binomial coefficients coprime to 105, hence divisible by none of 3, 5, and 7?](catalog-0301-0400.md#JSP-000311) | Progress | No | No | Unavailable |
| JSP-000312 | [How large is the reciprocal sum of primes that do not divide the specified central binomial coefficient?](catalog-0301-0400.md#JSP-000312) | Progress | No | No | Unavailable |
...
| JSP-000323 | [When a factorial is a product of distinct integers all larger than its index, how small can the largest factor be?](catalog-0301-0400.md#JSP-000323) | Progress | Pending confirmation | No | Unavailable |
| JSP-000324 | [How narrow an interval can contain all the distinct factors in a factorization of a factorial?](catalog-0301-0400.md#JSP-000324) | Progress | No | No | Unavailable |
| JSP-000325 | [What conditions on an interval's starting point make its consecutive-integer product divisible by a prescribed integer?](catalog-0301-0400.md#JSP-000325) | Progress | No | No | Unavailable |
| JSP-000326 | [Can a central binomial coefficient be divisible by the specified descending product of arbitrarily many consecutive integers?](catalog-0301-0400.md#JSP-000326) | Progress | No | No | Unavailable |
...
| JSP-000335 | [What is the distribution of the number of totient iterations needed to reach one?](catalog-0301-0400.md#JSP-000335) | Progress | No | No | Unavailable |
...
| JSP-000338 | [When does iteration of the map sending an integer to itself plus its totient eventually follow a doubling pattern?](catalog-0301-0400.md#JSP-000338) | Progress | No | No | Unavailable |
| JSP-000339 | [Do sum-of-divisors iteration trajectories from different starting integers eventually meet?](catalog-0301-0400.md#JSP-000339) | Progress | No | No | Unavailable |
| JSP-000340 | [Are there infinitely many bounds such that every smaller integer plus its number of distinct prime factors stays below the bound? Does this remain true with any fixed positive multiplier on the prime-factor count?](catalog-0301-0400.md#JSP-000340) | Progress | No | No | Unavailable |
...
| JSP-000342 | [Which orderings of totient values at consecutive integers occur, and with what frequencies?](catalog-0301-0400.md#JSP-000342) | Progress | No | No | Unavailable |
| JSP-000343 | [What is the precise asymptotic number of distinct totient values in a prescribed range?](catalog-0301-0400.md#JSP-000343) | Progress | No | No | Unavailable |
...
| JSP-000345 | [What is the distribution of the ratio of divisor counts of factorials with nearby indices?](catalog-0301-0400.md#JSP-000345) | Progress | No | No | Unavailable |
...
| JSP-000348 | [Determine the long-term growth of the integer sequence generated greedily by the prescribed consecutive-sum rule.](catalog-0301-0400.md#JSP-000348) | Progress | No | No | Unavailable |
...
| JSP-000350 | [How large can a subset of an integer interval be if the specified distinct element combinations always have different products?](catalog-0301-0400.md#JSP-000350) | Progress | No | No | Unavailable |
...
| JSP-000353 | [inverse Goldbach problem](catalog-0301-0400.md#JSP-000353) | Progress | No | No | Unavailable |
...
| JSP-000355 | [How small can the starting point of a run of consecutive prescribed power residues modulo a prime be?](catalog-0301-0400.md#JSP-000355) | Progress | No | No | Unavailable |
...
| JSP-000368 | [Determine the difference between the sum of symmetrically placed primes in the prime sequence and twice the middle prime.](catalog-0301-0400.md#JSP-000368) | Progress | No | No | Unavailable |
| JSP-000369 | [How fast must an increasing prime sequence with nondecreasing gaps grow?](catalog-0301-0400.md#JSP-000369) | Progress | No | No | Unavailable |
...
| JSP-000407 | [What is the minimum number of colors needed to color the plane so that points at distance one have different colors?](catalog-0401-0500.md#JSP-000407) | Progress | No | No | Unavailable |
| JSP-000408 | [How small can the total radii of disks covering the set where a polynomial has modulus at most one be?](catalog-0401-0500.md#JSP-000408) | Progress | No | No | Unavailable |
| JSP-000409 | [Chowla's cosine problem](catalog-0401-0500.md#JSP-000409) | Progress | No | No | Unavailable |
...
| JSP-000411 | [What is the optimal guaranteed liminf of the ratio of the largest series term of a transcendental entire function to its maximum modulus on a circle?](catalog-0401-0500.md#JSP-000411) | Progress | No | No | Unavailable |
| JSP-000412 | [Does every transcendental entire function have a path to infinity along which its modulus grows faster than every polynomial?](catalog-0401-0500.md#JSP-000412) | Progress | No | No | Unavailable |
...
| JSP-000414 | [Must an entire function with sufficiently sparse nonzero power-series terms attain every complex value infinitely often?](catalog-0401-0500.md#JSP-000414) | Progress | No | No | Unavailable |
...
| JSP-000424 | [What exponential growth constant governs the number of self-avoiding lattice walks of a given length?](catalog-0401-0500.md#JSP-000424) | Progress | No | No | Unavailable |
| JSP-000425 | [How fast does the mean endpoint distance of a random self-avoiding lattice walk grow with its length?](catalog-0401-0500.md#JSP-000425) | Progress | No | No | Unavailable |
| JSP-000426 | [How large a subset with distinct pairwise sums must every finite real set contain?](catalog-0401-0500.md#JSP-000426) | Progress | No | No | Unavailable |
| JSP-000427 | [How long an integer interval forces, under every two-coloring, a prescribed-size set whose nonempty subset sums are all the same color?](catalog-0401-0500.md#JSP-000427) | Progress | No | No | Unavailable |
...
| JSP-000429 | [How large can an integer set be if it contains no prescribed-size subset with all pairwise greatest common divisors equal?](catalog-0401-0500.md#JSP-000429) | Progress | No | No | Unavailable |
| JSP-000430 | [How large can an integer set be if it contains no three elements with equal pairwise least common multiples?](catalog-0401-0500.md#JSP-000430) | Progress | No | No | Unavailable |
...
| JSP-000432 | [How many distinct quotients of one set element by its greatest common divisor with another must occur?](catalog-0401-0500.md#JSP-000432) | Progress | No | No | Unavailable |
...
| JSP-000436 | [Which graph with a prescribed number of edges has the largest Ramsey number?](catalog-0401-0500.md#JSP-000436) | Progress | No | No | Unavailable |
...
| JSP-000454 | [Do two-color Ramsey numbers of three-uniform hypergraphs satisfy the predicted double-exponential lower bound?](catalog-0401-0500.md#JSP-000454) | Progress | No | No | Unavailable |
...
| JSP-000456 | [Under the specified local edge restrictions on one graph, is its Ramsey number against another graph linear in the latter's edge count?](catalog-0401-0500.md#JSP-000456) | Progress | No | No | Unavailable |
| JSP-000457 | [For specified graphs such as the cube, is the Ramsey number against an arbitrary graph bounded by a fixed multiple of the latter's edge count?](catalog-0401-0500.md#JSP-000457) | Progress | No | No | Unavailable |
...
| JSP-000477 | [How many rich lines can a planar point set determine when the number of points on each line is bounded?](catalog-0401-0500.md#JSP-000477) | Progress | No | No | Unavailable |
| JSP-000478 | [How large a subset with no three collinear points must every planar set with no four collinear points contain?](catalog-0401-0500.md#JSP-000478) | Progress | No | No | Unavailable |
...
| JSP-000480 | [Which ordinal powers have the partition property forcing a clique of the same order type in one color or a triangle in the other?](catalog-0401-0500.md#JSP-000480) | Progress | No | No | Unavailable |
| JSP-000481 | [Which finite hypergraphs must occur in every three-uniform hypergraph of uncountable chromatic number?](catalog-0401-0500.md#JSP-000481) | Progress | No | No | Unavailable |
| JSP-000482 | [Is there an infinite graph with no four-vertex clique that cannot be partitioned into countably many triangle-free parts?](catalog-0401-0500.md#JSP-000482) | Progress | No | No | Unavailable |
...
| JSP-000484 | [Which order-isomorphic structures are forced in two-color partitions of uncountable ordinals after excluding the specified cliques?](catalog-0401-0500.md#JSP-000484) | Progress | No | No | Unavailable |
...
| JSP-000499 | [If every prescribed-size local edge family in a uniform hypergraph has a common vertex, how many vertices suffice to cover all edges?](catalog-0401-0500.md#JSP-000499) | Progress | No | No | Unavailable |
...
| JSP-000519 | [Can the property of forcing a monochromatic triangle under every finite edge coloring be extended to infinite cardinal sizes?](catalog-0501-0600.md#JSP-000519) | Progress | No | No | Unavailable |
...
| JSP-000522 | [How many edges can a graph have if every cycle has fewer chords than vertices?](catalog-0501-0600.md#JSP-000522) | Progress | No | No | Unavailable |
| JSP-000523 | [How many edges force a uniform hypergraph to contain two distinct pairs of disjoint edges with the same union?](catalog-0501-0600.md#JSP-000523) | Progress | No | No | Unavailable |
| JSP-000524 | [If each prescribed local part of a set family has a two-point transversal, how many points suffice to meet the whole family?](catalog-0501-0600.md#JSP-000524) | Progress | No | No | Unavailable |
...
| JSP-000543 | [orchard problems](catalog-0501-0600.md#JSP-000543) | Progress | No | No | Unavailable |
| JSP-000544 | [How large a diameter is forced in higher dimensions when all pairwise distances are distinct and separated by a prescribed amount?](catalog-0501-0600.md#JSP-000544) | Progress | No | No | Unavailable |
| JSP-000545 | [If interpolation amplification factors diverge at every point, can every continuous function still have a point of interpolation convergence?](catalog-0501-0600.md#JSP-000545) | Progress | No | No | Unavailable |
...
| JSP-000555 | [Large prime factors of binomial coefficients and runs of smooth integers](catalog-0501-0600.md#JSP-000555) | Progress | No | No | Unavailable |
| JSP-000556 | [When does the small-prime part of a binomial coefficient exceed the square of its upper parameter?](catalog-0501-0600.md#JSP-000556) | Progress | No | No | Unavailable |
...
| JSP-000579 | [How short an interval beyond the first several positive integers can contain distinct multiples representing each of them?](catalog-0501-0600.md#JSP-000579) | Progress | No | No | Unavailable |
| JSP-000580 | [From an arbitrary starting point, what is the worst-case interval length needed for distinct multiples of the first several positive integers?](catalog-0501-0600.md#JSP-000580) | Progress | No | No | Unavailable |
| JSP-000581 | [What is the maximum edge density of a uniform hypergraph excluding a prescribed complete uniform hypergraph?](catalog-0501-0600.md#JSP-000581) | Progress | No | No | Unavailable |
| JSP-000582 | [Does every fixed bipartite graph have an extremal function asymptotic to a constant times a rational power?](catalog-0501-0600.md#JSP-000582) | Progress | No | No | Unavailable |
| JSP-000583 | [Can graphs excluding a prescribed balanced complete bipartite graph attain the predicted extremal lower bound?](catalog-0501-0600.md#JSP-000583) | Progress | No | No | Unavailable |
...
| JSP-000592 | [How many mutually orthogonal Latin squares can always be constructed at a given order?](catalog-0501-0600.md#JSP-000592) | Progress | No | No | Unavailable |
| JSP-000593 | [What is the asymptotic number of Latin rectangles with prescribed dimensions?](catalog-0501-0600.md#JSP-000593) | Progress | No | No | Unavailable |
...
| JSP-000604 | [Can graphs of arbitrarily high chromatic number be constructed without changing the finite subgraph types that occur?](catalog-0601-0700.md#JSP-000604) | Progress | No | No | Unavailable |
...
| JSP-000607 | [Does a graph of infinite chromatic number have subgraphs of every smaller infinite chromatic number?](catalog-0601-0700.md#JSP-000607) | Progress | No | No | Unavailable |
| JSP-000608 | [Can short-odd-cycle structures be removed from a graph of infinite chromatic number while preserving its chromatic number?](catalog-0601-0700.md#JSP-000608) | Progress | No | No | Unavailable |
...
| JSP-000617 | [Can an integer set have uniformly bounded two-term representation counts while its sumset density is arbitrarily close to one?](catalog-0601-0700.md#JSP-000617) | Progress | No | No | Unavailable |
...
| JSP-000645 | [Can a dense integer set have the property that equal products always use the same number of factors?](catalog-0601-0700.md#JSP-000645) | Progress | No | No | Unavailable |
| JSP-000646 | [How large a subset of an arbitrary finite real set can have all pairwise sums outside the original set?](catalog-0601-0700.md#JSP-000646) | Progress | No | No | Unavailable |
| JSP-000647 | [What tradeoff relates the size of a subset whose pairwise sums avoid a given set to the number of forbidden sums?](catalog-0601-0700.md#JSP-000647) | Progress | No | No | Unavailable |
| JSP-000648 | [How large a subset of an arbitrary finite set can have no equal sums using different numbers of terms?](catalog-0601-0700.md#JSP-000648) | Progress | No | No | Unavailable |
| JSP-000649 | [How large a subset of an arbitrary finite integer set can have no element equal to a sum of distinct other elements?](catalog-0601-0700.md#JSP-000649) | Progress | No | No | Unavailable |
| JSP-000650 | [How small can an integer set be if its two-term sums cover an initial integer interval?](catalog-0601-0700.md#JSP-000650) | Progress | No | No | Unavailable |
| JSP-000651 | [How large a sum-free subset must every finite integer set contain?](catalog-0601-0700.md#JSP-000651) | Progress | No | No | Unavailable |
...
| JSP-000667 | [Can a dense graph be edge-colored with linearly many colors so that every four-cycle is rainbow?](catalog-0601-0700.md#JSP-000667) | Progress | No | No | Unavailable |
| JSP-000668 | [Which rainbow subgraphs are forced by the specified balanced restrictions on edge-color usage?](catalog-0601-0700.md#JSP-000668) | Progress | No | No | Unavailable |
| JSP-000669 | [How much must the ratio and difference of successive clique Ramsey thresholds grow when the target order increases by one?](catalog-0601-0700.md#JSP-000669) | Progress | No | No | Unavailable |
...
| JSP-000677 | [Which numbers of positive-integer preimages can a totient value have?](catalog-0601-0700.md#JSP-000677) | Progress | No | No | Unavailable |
...
| JSP-000694 | [How many subsets of a planar point set in general position are in convex position?](catalog-0601-0700.md#JSP-000694) | Progress | No | No | Unavailable |
...
| JSP-000696 | [How much can allowing very few repeated pairwise sums increase the maximum size over that of a Sidon set?](catalog-0601-0700.md#JSP-000696) | Progress | No | No | Unavailable |
...
| JSP-000703 | [Matching prime-factor sets across shifted integer pairs](catalog-0701-0800.md#JSP-000703) | Progress | No | No | Unavailable |
...
| JSP-000708 | [second Hardy-Littlewood conjecture](catalog-0701-0800.md#JSP-000708) | Progress | No | No | Unavailable |
| JSP-000709 | [How large can an integer set's reciprocal sum be if it has no prescribed-size subset with all pairwise least common multiples equal?](catalog-0701-0800.md#JSP-000709) | Progress | No | No | Unavailable |
| JSP-000710 | [weak sunflower problem](catalog-0701-0800.md#JSP-000710) | Progress | No | No | Unavailable |
...
| JSP-000721 | [What growth conditions on representation counts ensure that a higher-order additive basis contains a minimal basis of the same order?](catalog-0701-0800.md#JSP-000721) | Progress | No | No | Unavailable |
...
| JSP-000723 | [How long does optimal play last when players alternately choose integers incomparable by divisibility with all previously chosen integers?](catalog-0701-0800.md#JSP-000723) | Progress | No | No | Unavailable |
| JSP-000724 | [How often can a prescribed number of consecutive terms of an increasing integer sequence have small least common multiple?](catalog-0701-0800.md#JSP-000724) | Progress | No | No | Unavailable |
...
| JSP-000727 | [How small can consecutive gaps be in an infinite increasing integer sequence with no term a subset sum of earlier distinct terms?](catalog-0701-0800.md#JSP-000727) | Progress | No | No | Unavailable |
...
| JSP-000736 | [Can the divisor-difference sets of two distinct integers have arbitrarily many common values?](catalog-0701-0800.md#JSP-000736) | Progress | No | No | Unavailable |
| JSP-000737 | [How many divisors can an integer have in a short interval near its square root?](catalog-0701-0800.md#JSP-000737) | Progress | No | No | Unavailable |
| JSP-000738 | [Is there a uniform constant bound on the number of divisors in a fourth-root-length interval near an integer's square root?](catalog-0701-0800.md#JSP-000738) | Progress | No | No | Unavailable |
...
| JSP-000773 | [Which disjoint consecutive-integer intervals have products with exactly the same prime-factor set?](catalog-0701-0800.md#JSP-000773) | Progress | No | No | Unavailable |
| JSP-000774 | [How often do consecutive primes enclose at least two integers having only sufficiently small prime factors?](catalog-0701-0800.md#JSP-000774) | Progress | No | No | Unavailable |
| JSP-000775 | [How large can the part supported on powers of two and three in a product of consecutive integers be?](catalog-0701-0800.md#JSP-000775) | Progress | No | No | Unavailable |
| JSP-000776 | [Under a maximum-degree bound, how many edges force two edges sufficiently far apart in the graph?](catalog-0701-0800.md#JSP-000776) | Progress | No | No | Unavailable |
...
| JSP-000778 | [How often are powers of two or factorials plus or minus one powerful numbers?](catalog-0701-0800.md#JSP-000778) | Progress | No | No | Unavailable |
...
| JSP-000780 | [Can higher-powerful integers satisfying the required coprimality conditions obey an additive relation in which one is the sum of the other two?](catalog-0701-0800.md#JSP-000780) | Progress | No | No | Unavailable |
| JSP-000781 | [How many integers are sums of a bounded number of higher-powerful numbers, and what density do they have?](catalog-0701-0800.md#JSP-000781) | Progress | No | No | Unavailable |
...
| JSP-000783 | [How many powerful numbers can lie between consecutive squares?](catalog-0701-0800.md#JSP-000783) | Progress | No | No | Unavailable |
...
| JSP-000795 | [If an integer set has density zero, must the integers whose proper-divisor sums lie in that set also have density zero?](catalog-0701-0800.md#JSP-000795) | Progress | No | No | Unavailable |
...
| JSP-000803 | [What is the smallest possible order of the error in counting squarefree positive integers?](catalog-0801-0900.md#JSP-000803) | Progress | No | No | Unavailable |
| JSP-000804 | [Jacobsthal's function](catalog-0801-0900.md#JSP-000804) | Progress | No | No | Unavailable |
| JSP-000805 | [For a fixed modulus, how many coprime residue classes have an unusually large least prime?](catalog-0801-0900.md#JSP-000805) | Progress | No | No | Unavailable |
| JSP-000806 | [For an irrational number satisfying the stated conditions, are infinitely many floors of its products with primes also prime?](catalog-0801-0900.md#JSP-000806) | Progress | No | No | Unavailable |
...
| JSP-000816 | [If an integer set is larger than the prime count in its range, must some collection of its elements be supported on relatively few small primes?](catalog-0801-0900.md#JSP-000816) | Progress | No | No | Unavailable |
...
| JSP-000829 | [Does sufficiently fast decay of Fourier approximation error ensure convergence of averages along the prescribed sparse sequence?](catalog-0801-0900.md#JSP-000829) | Progress | No | No | Unavailable |
...
| JSP-000834 | [What limiting distribution arises from normalized cumulative centered fractional parts of an irrational rotation?](catalog-0801-0900.md#JSP-000834) | Progress | No | No | Unavailable |
...
| JSP-000861 | [For a monic real-rooted polynomial, how long in total can the real intervals on which its absolute value is less than one be?](catalog-0801-0900.md#JSP-000861) | Progress | No | No | Unavailable |
| JSP-000862 | [How large a disk can lie in the region where a polynomial has modulus at most one?](catalog-0801-0900.md#JSP-000862) | Progress | No | No | Unavailable |
| JSP-000863 | [Under restrictions on polynomial zeros, how do the area and transfinite diameter of a modulus sublevel set relate?](catalog-0801-0900.md#JSP-000863) | Progress | No | No | Unavailable |
...
| JSP-000874 | [How can a target integer be represented as the sum of an initial segment of another integer's ordered nontrivial divisors?](catalog-0801-0900.md#JSP-000874) | Progress | No | No | Unavailable |
...
| JSP-000889 | [What proportion of every finite planar point set can be selected with no pair at unit distance?](catalog-0801-0900.md#JSP-000889) | Progress | No | No | Unavailable |
...
| JSP-000917 | [How many distinct prime factors occur among a sequence of integer partition numbers?](catalog-0901-1000.md#JSP-000917) | Progress | No | No | Unavailable |
| JSP-000918 | [For each prescribed order, is every sufficiently large integer a sum of one more than that order many integers whose prime-factor exponents are all at least that order?](catalog-0901-1000.md#JSP-000918) | Progress | No | No | Unavailable |
| JSP-000919 | [Under the stated restrictions, are only finitely many sums of distinct factorials perfect powers or powerful numbers?](catalog-0901-1000.md#JSP-000919) | Progress | No | No | Unavailable |
| JSP-000920 | [How large can an integer-interval subset be if every pairwise sum is nonsquarefree?](catalog-0901-1000.md#JSP-000920) | Progress | No | No | Unavailable |
| JSP-000921 | [Which integers are sums of products of powers of two fixed bases when no chosen summand may divide another?](catalog-0901-1000.md#JSP-000921) | Progress | No | No | Unavailable |
...
| JSP-000932 | [If an additive arithmetic function is nondecreasing outside a zero-density exception set, must it be a constant multiple of the logarithm?](catalog-0901-1000.md#JSP-000932) | Progress | No | No | Unavailable |
...
| JSP-000938 | [What is the minimum sum of squared integrals of the Lagrange basis functions?](catalog-0901-1000.md#JSP-000938) | Progress | No | No | Unavailable |
| JSP-000939 | [For interpolation built from successive initial segments of an infinite node sequence, what lower bound must the amplification factor satisfy at a fixed point?](catalog-0901-1000.md#JSP-000939) | Progress | No | No | Unavailable |
| JSP-000940 | [Even allowing degree slightly above the minimum, can bounded interpolation data force every interpolating polynomial to have large amplitude?](catalog-0901-1000.md#JSP-000940) | Progress | No | No | Unavailable |
...
| JSP-000956 | [With Chebyshev interpolation nodes, can all limit points of the interpolation sequence at the specified positions be prescribed?](catalog-0901-1000.md#JSP-000956) | Progress | No | No | Unavailable |
| JSP-000957 | [Can a slight increase in interpolation degree avoid almost-everywhere divergence for continuous functions?](catalog-0901-1000.md#JSP-000957) | Progress | No | No | Unavailable |
...
| JSP-000959 | [Can subrings or subfields of the reals have any prescribed Hausdorff dimension strictly between zero and one?](catalog-0901-1000.md#JSP-000959) | Progress | No | No | Unavailable |
| JSP-000960 | [After repeatedly choosing random triangles and deleting their edges, how many graph edges remain and what structure results?](catalog-0901-1000.md#JSP-000960) | Progress | No | No | Unavailable |
| JSP-000961 | [How narrow an integer range typically contains the chromatic number of a random graph?](catalog-0901-1000.md#JSP-000961) | Progress | No | No | Unavailable |
...
| JSP-000963 | [What extremal lower bounds can be constructed for uniform hypergraphs excluding a prescribed complete multipartite hypergraph?](catalog-0901-1000.md#JSP-000963) | Progress | No | No | Unavailable |
| JSP-000964 | [Does a finite projective plane have a blocking set meeting every line in a uniformly bounded number of points?](catalog-0901-1000.md#JSP-000964) | Progress | No | No | Unavailable |
| JSP-000965 | [Among group orders up to a bound, is the greatest number of nonisomorphic groups attained at a power-of-two order?](catalog-0901-1000.md#JSP-000965) | Progress | No | No | Unavailable |
...
| JSP-000967 | [How many subgroups does a symmetric group have, and how are their orders distributed?](catalog-0901-1000.md#JSP-000967) | Progress | No | No | Unavailable |
...
| JSP-000973 | [Can the specified negative partition relations at successors of singular cardinals be proved without the generalized continuum hypothesis?](catalog-0901-1000.md#JSP-000973) | Progress | No | No | Unavailable |
| JSP-000974 | [Can pairs on the ordinal square of the first uncountable ordinal be two-colored to avoid the specified monochromatic order types?](catalog-0901-1000.md#JSP-000974) | Progress | No | No | Unavailable |
| JSP-000975 | [Is the specified two-color partition property of the second uncountable ordinal for all smaller order types consistent with the usual set-theoretic axioms?](catalog-0901-1000.md#JSP-000975) | Progress | No | No | Unavailable |
| JSP-000976 | [Which monochromatic triangles or order types are forced by multicolorings on the ordinal square of the first uncountable ordinal?](catalog-0901-1000.md#JSP-000976) | Progress | No | No | Unavailable |
...
| JSP-000979 | [Can graphs exclude a large clique while forcing a prescribed smaller monochromatic clique under every countable coloring?](catalog-0901-1000.md#JSP-000979) | Progress | No | No | Unavailable |
| JSP-000980 | [Does sufficiently high chromatic number force a triangle-free subgraph whose chromatic number reaches a prescribed uncountable cardinal?](catalog-0901-1000.md#JSP-000980) | Progress | No | No | Unavailable |
| JSP-000981 | [Can edges of an uncountable-chromatic graph be colored so that every prescribed vertex coloring has a color class realizing all edge colors?](catalog-0901-1000.md#JSP-000981) | Progress | No | No | Unavailable |
...
| JSP-000994 | [How many modulus sets support irreducible coverings, and what size restrictions must they satisfy?](catalog-0901-1000.md#JSP-000994) | Progress | No | No | Unavailable |
...
| JSP-000996 | [Can the square-root density restriction for infinite Sidon sets be strengthened by the predicted logarithmic correction?](catalog-0901-1000.md#JSP-000996) | Progress | No | No | Unavailable |
...
| JSP-001014 | [Can a rapidly growing integer sequence admit infinitely many integer shifts making all its terms prime?](catalog-1001-1022.md#JSP-001014) | Progress | No | No | Unavailable |
